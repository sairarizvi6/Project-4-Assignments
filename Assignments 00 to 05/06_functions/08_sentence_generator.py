#Implement the helper function make_sentence(word, part_of_speech) 
#which will take a string word and an integer part_of_speech as parameters and, 
#depending on the part of speech,place the word into one of three sentence templates
...
#Type 0 for noun, 1 for verb, 2 for adjective: 2 Looking out my window, 
#the sky is big and groovy!
