...
#(Note.This idea is called tuple packing/unpacking. We "pack" our return values 
# into a single data structure called a tuple. 
# We can then "unpack" these values back into our original values or leave them as a tuple.)
